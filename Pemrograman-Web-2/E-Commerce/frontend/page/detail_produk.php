                    ...
                    <div id="carouselExampleCaptions" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../assets/img/sidebanner1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/img/sidebanner2.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/img/sidebanner3.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="list-produk d-flex flex-wrap justify-conten">
                                    ...
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) :
                                        // Retrieve the ID of the current similar product
                                        $similarProductId = $row['id'];

                                        // Perform a new query to fetch the details of the similar product
                                        $similarProductSql = "SELECT * FROM produk WHERE id != ? LIMIT 4";
                                        $similarProductStmt = $conn->prepare($similarProductSql);
                                        $similarProductStmt->execute([$similarProductId]);
                                        $similarProductRow = $similarProductStmt->fetch(PDO::FETCH_ASSOC);


                                    ?>
                                        <div class="list-produk d-flex flex-wrap justify-conten">
                                            <div class="card" style="width: 18rem; ">
                                                <img src="..\assets\img\<?= $similarProductRow['nama'] ?>.jpg" class="card-img-top" alt="produk1">
                                                <div class="card-body">
                                                    <h5 class="card-title"><?= $similarProductRow['nama'] ?></h5>
                                                    <h6 class="card-subtitle mb-2 text-muted">RP<?= $similarProductRow['harga_jual'] ?></h6>
                                                    ...
                                                    <br>
                                                    <a href="detail_produk.php?id=<?= $similarProductRow['id'] ?>" class="btn btn-primary mt-2">Lihat Detail</a>
                                                </div>
                                            </div>
